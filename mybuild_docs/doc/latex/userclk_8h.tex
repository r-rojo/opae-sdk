\doxysection{opae-\/libs/include/opae/userclk.h File Reference}
\label{userclk_8h}\index{opae-\/libs/include/opae/userclk.h@{opae-\/libs/include/opae/userclk.h}}
...
\hline
\mbox{\texttt{ in}}  & {\em high\+\_\+clk} & A\+FU High user clock frequency in M\+Hz. \\
\hline
\mbox{\texttt{ in}}  & {\em low\+\_\+clk} & A\+FU Low user clock frequency in M\+Hz. \\
\hline
...
\mbox{\texttt{ in}}  & {\em handle} & Handle to previously opened accelerator resource. \\
\hline
\mbox{\texttt{ out}}  & {\em high\+\_\+clk} & A\+FU High user clock frequency in M\+Hz. \\
\hline
\mbox{\texttt{ out}}  & {\em low\+\_\+clk} & A\+FU Low user clock frequency in M\+Hz. \\
\hline
\mbox{\texttt{ in}}  & {\em flags} & Flags Reserved.\\
\hline
\end{DoxyParams}
