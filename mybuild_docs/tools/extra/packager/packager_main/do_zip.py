...
z.write('/root/mybuild_docs/tools/extra/packager/packager.py', 'packager.py')
z.write('afu.py')
z.write('gbs.py')
z.write('utils.py')
...
z.write('README')
z.write('/root/mybuild_docs/tools/extra/packager/packager_main/__main__.py', '__main__.py')
z.close()

# Write out the buffer
with open('/root/mybuild_docs/bin/packager', 'wb') as f:
