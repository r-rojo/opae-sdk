...
z.write('/root/mybuild_docs/platforms/scripts/bin/afu_platform_info.py', 'afu_platform_info.py')
z.write('platmgr/__init__.py')
z.write('platmgr/jsondb.py')
z.write('platmgr/emitcfg.py')
z.write('/root/mybuild_docs/platforms/scripts/afu_platform_info_main/__main__.py', '__main__.py')
z.close()

# Write out the buffer
with open('/root/mybuild_docs/bin/afu_platform_info', 'wb') as f:
