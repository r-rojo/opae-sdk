...
execute_process(
  COMMAND "/usr/bin/git" show-ref v2.6.0
  WORKING_DIRECTORY "/root/external/pybind11"
...
if("${show_ref_output}" MATCHES "refs/remotes/v2.6.0")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "v2.6.0")
...
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 v2.6.0
  WORKING_DIRECTORY "/root/external/pybind11"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/root/external/pybind11/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/root/external/pybind11/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
